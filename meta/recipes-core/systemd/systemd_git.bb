...
SRC_URI = "git://anongit.freedesktop.org/systemd/systemd \
...
S = "${WORKDIR}/git"
# HEAD broken with ttyS0
SRCREV = "ecd2f2c5947d9e2f4d6792c2a3a90b8ced6a5b3e"
# still broken with ttyS0 ~400 back
#SRCREV = "3d2df82d61b3022820a34f59132d2c41ea11316c"
# ~600 back - works failed on systemdonly on AB?
#SRCREV = "63966da86d8e71b1f3f2b57d5448770d526421f9"
# ~500 back - fails with ttyS0
#SRCREV = "f72a3e5bada52593aae7cf5fe577138165e83ff3"
#~550 back - fails witg ttyS0
#SRCREV = "050eb34da8bfe26ecdbda072ce945210279a9753"
# still fails with ttyS0
#SRCREV = "4d47756b8fa5eb6bc75b7aa2345eb31e6bc10e9a"
# still fails with ttyS0
#SRCREV = "53461b74df0576ec091275d1a5dbee00611df1ee"
# works
#SRCREV = "ddae67fa1bdd86b480a60ad6fc1d90d6f35a03d0"
# works
#SRCREV = "3e8a51eae6815eb9f54a6b672ba5e1a17d0bffe9"
# fails
#SRCREV = "b43b8f7a7e088c31416374340f576887968f7cad"
# fails
#now works
#SRCREV = "df32a1caafe881fc7850a9b569179b877198685f"
...
python populate_packages_prepend (){
    ...
    do_split_packages(d, libdir, '^lib(.*)\.so\.*', 'lib%s', 'Systemd %s library', extra_depends='', allow_links=True)
}
